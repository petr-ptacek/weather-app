...
export class WeatherApi {
  private static readonly REVERSE_GEO_API_URL = "https://api.openweathermap.org/geo/1.0/reverse";
   ...
   */
  static async getCityByCoords(params: GetCityByCoordsParams): Promise<City | null> {
    const data = await WeatherApi.request<CityDTO[]>(WeatherApi.REVERSE_GEO_API_URL, {
      lat: params.lat,
      lon: params.lon,
      limit: 1
    });
